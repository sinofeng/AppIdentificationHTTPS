...
static char const GCC_UNUSED rcsid[] =
    "@(#)$Header: /usr/local/cvs/tcptrace/tcptrace.c,v 5.58 2003/11/19 14:38:05 sdo Exp $";
...
DumpFlags(void)
{
    ...
    fprintf(stderr,"print_denis:        %s\n", BOOL2STR(print_denis));
