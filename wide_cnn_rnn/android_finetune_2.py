...
train=pd.read_csv("../../data/finetune_train.csv")
test=pd.read_csv("../../data/finetune_test.csv")
...
d.compile(optimizer=Adam(lr=0.00001),loss="categorical_crossentropy",metrics=["accuracy"])
